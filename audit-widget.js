...
const CONFIG = {
  ...
  WHATSAPP_NUMBER: "91XXXXXXXXXX", // replace with the real WhatsApp business number, country code, no + or spaces
  SCALE_URL: "#" // replace with the real Scale checkout / page link
};
...
function renderResult(){
  ...
  app.innerHTML = `
    <div class="screen" style="padding-top:24px;">
      ...
      <div class="side-sell">
        <div class="label">Not ready for that conversation yet?</div>
        <p>Start with <strong>Scale</strong> instead \u2014 fourteen short chapters on exactly why businesses like ${bizSafe} are starting to pull ahead right now. No jargon, no commitment either way, and it's yours to keep even if we never speak.</p>
        <a class="btn btn-soft" href="${CONFIG.SCALE_URL}" target="_blank">Get Scale for \u20B9499</a>
      </div>
